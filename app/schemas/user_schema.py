...
class UserCreate(BaseModel):
    ...
    def validate_fullname(cls, v: str):
        ...
        if clean_name == v:
            raise ValueError('O nome completo deve ter ao menos um espaço, EX: mariajose sobrenome')
    ...
    def validate_password(cls, v: str):
        ...
        if not re.search(r'[@$!%*?&]', v):
            raise ValueError('Sua senha deve conter um caracter especial do tipo: @#$%!&?')
